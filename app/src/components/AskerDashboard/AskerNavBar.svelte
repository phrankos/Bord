<script>
    ...
    let role;
    export let showTaskCreateModal; // Import the showTaskCreateModal variable
        ...
        <div class="flex justify-between items-center p-4">
            ...
            <div class="flex space-x-4">
                <nav class="hidden md:flex items-center gap-4 lg:gap-6">
                    ...
                    <a href="#" class="text-lg font-bold font-mono transition duration-200 hover:text-indigo-700" on:click={() => showTaskCreateModal = true}>Create TASK</a>
